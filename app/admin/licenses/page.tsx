...
import { Search, Key, ShieldCheck, ShieldAlert, Copy, RefreshCw, User, Package, ExternalLink, MoreVertical, CheckCircle2, History } from "lucide-react"
        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <header className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between px-2">
                ...
                <div className="flex items-center gap-3">
                    <button className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/[0.03] border border-white/[0.05] text-white/40 hover:text-white transition-all group">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center justify-between px-2">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <div className="flex items-center gap-2 text-white/20 text-[10px] font-black uppercase tracking-[0.2em]">
                        Showing <span className="text-white font-black">{licenses.length}</span> keys
                    </div>
                </div>
            </div>
            ...
            <div className="rounded-[2.5rem] border border-white/[0.05] bg-surface/30 backdrop-blur-md overflow-hidden">
                                ...
                                <tr key={license.id} className="group hover:bg-white/[0.015] transition-all">
                                    ...
                                    <td className="px-8 py-6">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            <button className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/[0.03] text-white/30 hover:bg-white/[0.1] hover:text-white transition-all">
                ...
                <div className="flex items-center justify-between border-t border-white/[0.05] bg-white/[0.01] px-8 py-6">
                    <div className="flex items-center gap-2 text-[10px] font-black text-emerald-400/60 uppercase tracking-[0.2em] group cursor-pointer">
